...
class Calculator extends Component {
  ...
  clickNum = num => () => {
    ...
    if (is_float === false) {
      if (operator === false) {
        if (is_first_num === true) {
          // [CASE 1] 연산자: 없음, 첫번째 숫자타이핑: Y
          is_first_num = false
          num_displayed = num
        } else {
          // [CASE 2] 연산자: 없음, 첫번째 숫자: N
          num_displayed = num_displayed * 10 + num
        }
      } else {
        if (is_first_num === true) {
          // [CASE 3] 연산자: 있음, 첫번째 숫자타이핑: Y
          is_overlapped = false
    ...
    //for 소수점 아래//
      ...
      if (operator === false) {
        if (is_under_first_num === true) {
          // [CASE 1] 연산자: 없음, 첫번째 소수 타이핑: Y
          is_under_first_num = false
          num_under_point = num * exp
          num_displayed = num_displayed + num_under_point
        } else {
          // [CASE 2] 연산자: 없음, 첫번째 소수 타이핑: N
          num_under_point = num * exp
          num_displayed = num_displayed + num_under_point
        }
      } else {
        if (is_under_first_num === true) {
          // [CASE 3] 연산자: 있음, 첫번째 소수 타이핑: Y
          is_under_first_num = false
          is_overlapped = false
          num_under_point = num * exp
          num_displayed = num_displayed + num_under_point
        } else {
          // [CASE 4] 연산자: 있음, 첫번째 소수 타이핑: N
          num_under_point = num * exp
          num_displayed = num_displayed + num_under_point
        }
      }
        ...
        <div className="full">
          <div className="typingtool">
            <div className="flex_typingtool">
              <div className="shadow_typing">{this.state.shadow}</div>
              <div className="typing">{this.state.num_displayed}</div>
            </div>
          </div>
          ...
          <div className="caltool">
            <div className="flex_cartool">
              ...
              <div onClick={this.clickOper("/")} className="first_one">
                /
              </div>
            </div>

            <div className="flex_cartool">
              <div onClick={this.clickNum(7)} className="rest_one">
                7
              </div>
              <div onClick={this.clickNum(8)} className="rest_one">
                8
              </div>
              <div onClick={this.clickNum(9)} className="rest_one">
                9
              </div>
              <div onClick={this.clickOper("*")} className="rest_one">
                *
              </div>
            </div>

            <div className="flex_cartool">
              <div onClick={this.clickNum(4)} className="rest_one">
                4
              </div>
              <div onClick={this.clickNum(5)} className="rest_one">
                5
              </div>
              <div onClick={this.clickNum(6)} className="rest_one">
                6
              </div>
              <div onClick={this.clickOper("-")} className="rest_one">
                -
            ...
            <div className="flex_cartool">
              <div onClick={this.clickNum(1)} className="rest_one">
                1
              </div>
              <div onClick={this.clickNum(2)} className="rest_one">
                2
              </div>
              <div onClick={this.clickNum(3)} className="rest_one">
                3
              </div>
              <div onClick={this.clickOper("+")} className="rest_one">
                +
            ...
            <div className="flex_cartool">
              <div onClick={this.clickNum(0)} className="rest_two">
                0
              </div>
              <div onClick={this.clickPoint()} className="rest_one">
                .
              </div>
              <div onClick={this.clickOper("=")} className="rest_one">
                =
